...
```{r, message=FALSE, warning=FALSE, fig.cap="Daily nitrate by site (June–July 2019)", fig.alt="Line chart showing daily nitrate concentrations for ARIK, CARI, LEWI over June–July 2019."}
